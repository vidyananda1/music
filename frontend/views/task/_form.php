...
<div class="task-form">
    ...
    <div class="row">
        <div class="col-md-4">
         ...
         <div class="col-md-4">
             <?= $form->field($model, 'agent_id')->dropDownList($agent, ['prompt' => '--Select Agent--'])->label('Agent') ?>
        </div>
         <div class="col-md-4">
           
            <?= $form->field($model, 'meeting_schedule')->widget(
                            DatePicker::className(), [
                                // inline too, not bad
                                 'inline' => false, 
                                 
                                 'options' => ['placeholder' => 'schedule date','class'=> 'date'],
